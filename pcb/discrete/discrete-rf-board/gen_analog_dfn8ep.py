...
Z = 3.55 # distance across outer edges of pads
G = 2.10 # distance across inner edges of pads
...
show_fab_pads = False
H = 3.00 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.25 # physical pad width
L1 = -0.38 # physical pad length

D1 = 3.0 # package width
E1 = 3.0 # package height

has_ground_pad = True
G1 = 1.70  # ground pad width
H1 = 2.43  # ground pad height
ground_pad_num = 0
