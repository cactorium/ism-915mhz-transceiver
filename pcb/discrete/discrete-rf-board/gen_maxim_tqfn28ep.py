...
Z = 4.72 + 1.05 # distance across outer edges of pads
G = 4.72 - 1.05  # distance across inner edges of pads
...
L1 = -0.55 # physical pad length

D1 = 5.0 # package width
E1 = 5.0 # package height

has_ground_pad = True
G1 = 3.19  # ground pad width
H1 = 3.19  # ground pad height
ground_pad_num = 0
